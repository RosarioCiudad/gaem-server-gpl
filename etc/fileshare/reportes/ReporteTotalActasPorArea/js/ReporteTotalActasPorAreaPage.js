...
var ReporteTotalActasPorArea = function () {
	...
	var render = function (params) {
		...
		Page.label({"label":"TipoFormulario:"});
...
//			params.idDireccion = "";
	...
	module.accept = function () {
		...
		if (Page.messages().length == 0) {
			Adp.scheduleReport("ReporteTotalActasPorArea", "Iniciando Reporte", params);
		}
...
}();//end ReporteTotalActasPorArea

Grs.request(ReporteTotalActasPorArea);