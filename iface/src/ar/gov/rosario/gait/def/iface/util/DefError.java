...
public class DefError extends BaseError {
	...
	//static public String XXXXXX_XXXX_XXX   = addError(4000, "gait.base.xxxxxx");
	
	// Area Aplicacion Perfil
	public static final String AREAAPLICACIONPERFIL_LABEL         = addError(4000,"def.areaAplicacionPerfil.aplicacionPerfil.label");
	...
	public static final String TIPOBJIMP_ESGAIT        = addError(4103, "def.tipObjImp.esGait.label");
	...
	public static final String TIPOBJIMPATR_ESATRIBUTOGAIT   = addError(0,"def.tipObjImpAtr.esAtributoGAIT.label");
	...
	// ---> ABM Direccion	
	public static final String DIRECCION_LABEL           = addError(4145, "def.direccion.label");
	public static final String DIRECCION_DESCRIPCION     = addError(4146, "def.direccion.descripcion.label");
	// <--- ABM Direccion
	
	// ---> ABM DireccionAplicacionPerfil	
	public static final String DIRECCIONAPLICACIONPERFIL_LABEL           = addError(4945, "def.direccionAplicacionPerfil.label");
	public static final String DIRECCIONAPLICACIONPERFIL_DESCRIPCION     = addError(4946, "def.direccionAplicacionPerfil.descripcion.label");
	// <--- ABM DireccionAplicacionPerfil
	...
	public static final String RECURSO_EXISTEDETERMINACIONDEUDA = addError(4334, "def.recurso.existeDeterminacionDeuda.label");
	public static final String RECURSO_PERMITEMODVTODEU = addError(4335, "def.recurso.permiteModVtoDeu.label");
	...
	// ---> ABM EmiMatRecurso
	public static final String EMIMATRECURSO_LABEL   = addError(0, "def.emiMatRecurso.label");
	public static final String EMIMATRECURSO_EXISTE_RELACION_MSG   = addError(0, "def.emiMatRecurso.existeRelacion.msg");
	// <--- ABM EmiMatRecurso
	...
	// ---> ABM GaitScript
	public static final String GAITSCRIPT_LABEL 	 	 = addError(0, "def.gaitscript.label");
	public static final String GAITSCRIPT_CODGAITSCRIPT	 = addError(0, "def.gaitScript.codGaitScript.label");
	public static final String GAITSCRIPT_DESGAITSCRIPT  = addError(0, "def.gaitScript.desGaitScript.label");
	public static final String GAITSCRIPT_PATHGAITSCRIPT  = addError(0, "def.gaitScript.pathGaitScript.label");
	public static final String GAITSCRIPT_READGAITSCRIPT  = addError(0, "def.gaitScript.readGaitScript.label");	
	// <--- ABM GaitScript
	
	// ---> ABM GaitScriptUsr
	public static final String GAITSCRIPTUSR_LABEL			    = addError(0, "def.gaitscriptusr.label");
	public static final String GAITSCRIPTUSR_CODGAITSCRIPTUSR   = addError(0, "def.gaitscriptusr.label");
	public static final String GAITSCRIPTUSR_PROCESO 			= addError(0, "def.gaitScript.proceso.desProceso.label");
	public static final String GAITSCRIPTUSR_USRGAIT			= addError(0, "def.gaitScript.usuarioGait.label");
	// <--- ABM GaitScriptUsr
