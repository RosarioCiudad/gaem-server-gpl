 ...
 *
 */
public class ProcesoVO extends GaitBussImageModel {
	...
	private String cantCorridasPermView = "";
	// Constructores
	public ProcesoVO(){
		super();
	}
	...
	public void setCantCorridasPerm(Integer cantCorridasPerm) {
		...
		this.cantCorridasPermView = StringUtil.formatInteger(cantCorridasPerm);
	}
	public String getCantCorridasPermView() {
		return cantCorridasPermView;
	}
	public void setCantCorridasPermView(String cantCorridasPermView) {
		this.cantCorridasPermView = cantCorridasPermView;
	}
