package ar.gov.rosario.gait.${modulo}.buss.service;
...
import ar.gov.rosario.gait.${modulo}.buss.bean.${Bean};
import ar.gov.rosario.gait.${modulo}.buss.bean.${Modulo}${Submodulo}Manager;
import ar.gov.rosario.gait.${modulo}.buss.dao.${Modulo}DAOFactory;
import ar.gov.rosario.gait.${modulo}.iface.model.${Bean}Adapter;
import ar.gov.rosario.gait.${modulo}.iface.model.${Bean}SearchPage;
import ar.gov.rosario.gait.${modulo}.iface.model.${Bean}VO;
import ar.gov.rosario.gait.${modulo}.iface.service.I${Modulo}${Submodulo}Service;
