...
import ar.gov.rosario.gait.pro.buss.bean.ProManager;
...
import ar.gov.rosario.gait.pro.iface.model.EstadoCorridaVO;
import ar.gov.rosario.gait.pro.iface.model.FileCorridaVO;
...
import ar.gov.rosario.gait.pro.iface.model.TipoEjecucionVO;
import ar.gov.rosario.gait.pro.iface.model.TipoProgEjecVO;
import ar.gov.rosario.gait.pro.iface.service.IProConsultaService;
...
public class ProConsultaServiceHbmImpl implements IProConsultaService {
	...
	private void copyFromVO(Proceso proceso, ProcesoVO procesoVO){		
		...
		proceso.setCantCorridasPerm(procesoVO.getCantCorridasPerm());
	}
