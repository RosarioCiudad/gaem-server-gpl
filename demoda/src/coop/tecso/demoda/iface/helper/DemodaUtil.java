...
public class DemodaUtil {
	...
	private static Logger log = Logger.getLogger((DemodaUtil.class));
	/*
	...
	*/
	...
	public static void populateVO(Common modelVO, HttpServletRequest request) {
		...
		try {
			...
			//e.printStackTrace();
			//throws IllegalAccessException, InvocationTargetException, SecurityException, IllegalArgumentException, NoSuchMethodException
		}
			...
			if (returnType.indexOf("java.lang.String")>-1){
				try{
		            ...
		            if ("false".equals(atrTrimString)) {
		            	...
		            	vOMethodSet.invoke(cmmVO, value);
		            } else {
		            	//valorString esta trimeado
		            	vOMethodSet.invoke(cmmVO, valorString);
		            }
				} catch (Exception e){
					//e.printStackTrace();
