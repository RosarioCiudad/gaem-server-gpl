...
public class StringUtil {
    ...
    public static boolean isInteger (String strToValidate) {
		...
		try {
			Integer.parseInt(strToValidate);
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	* */
	...
	public static String toUpperLike(String s) {
		String ret = toLike(s) ;
		return ret == null ? null : ret.toUpperCase();
	}
