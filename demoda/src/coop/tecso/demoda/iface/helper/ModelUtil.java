...
public class ModelUtil {
    ...
    public static String logDiffDouble(Double dobleVO, Double doubleBO, String nombreCampo){
            
    	String logCambios="";

    	if (doubleBO != null && dobleVO == null){ 
    		logCambios = ", " + " se quit\u00F3 "+nombreCampo+ " " +doubleBO;		
    	}

    	if (doubleBO == null && dobleVO != null){ 
    		logCambios = ", " + nombreCampo+ " "  + dobleVO;		
    	}

    	if (doubleBO != null && dobleVO!= null && 
    			!doubleBO.equals(dobleVO) ){ 

    		logCambios = ", " + nombreCampo+ " "  + doubleBO +" por " + dobleVO;		
    	}
	...
	public static Long bussId(Common vo) {
		if (vo == null)
			return null;
