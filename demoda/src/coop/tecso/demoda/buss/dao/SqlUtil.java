...
public class SqlUtil {
	...
	/*
	 * Por razones de historia, en GAIT no se usan 'Hibernate Criteria'
	...
	/**
	 * Arma una sentencia SQL valida para la base de datos de gait para poder usar el tipo java Date en una sentencia SQL.
	 ...
	 * @param anio cadena para formar el anio, pj: 2000, o tabla.anio o cualquier expresion sql valida,
