package ar.gov.rosario.gait.def.view.util;
...
public interface DefConstants {
	...
	public static final String FWD_AREA_ADAPTER 	= "areaAdapter";
	...
	public static final String ACTION_ADMINISTRAR_ENC_AREA = "administrarEncArea";
	public static final String FWD_AREA_ENC_EDIT_ADAPTER 	= "areaEncEditAdapter";
	...
	// ---> EmiMatRecurso
	public static final String ACTION_ADMINISTRAR_EMIMATRECURSO  = "administrarEmiMatRecurso";
	public static final String FWD_EMIMATRECURSO_VIEW_ADAPTER	 = "emiMatRecursoViewAdapter";
	public static final String FWD_EMIMATRECURSO_EDIT_ADAPTER	 = "emiMatRecursoEditAdapter";
	// <--- EmiMatRecurso
	...
	// ---> GaitScript
	public static final String FWD_GAITSCRIPT_SEARCHPAGE 		= "gaitScriptSearchPage";
	public static final String FWD_GAITSCRIPT_ENC_EDIT_ADAPTER = "gaitScriptEncEditAdapter";
	public static final String ACTION_ADMINISTRAR_GAITSCRIPT 	= "administrarGaitScript";
	public static final String ACTION_ADMINISTRAR_ENC_GAITSCRIPT = "administrarEncGaitScript";	
	public static final String PATH_ADMINISTRAR_GAITSCRIPT = "/def/AdministrarGaitScript";
	public static final String FWD_GAITSCRIPT_VIEW_ADAPTER = "gaitScriptViewAdapter";
	public static final String FWD_GAITSCRIPT_EDIT_ADAPTER = "gaitScriptEditAdapter";	
	// <--- GaitScript
	
	// ---> GaitScriptUsr
	public static final String ACTION_ADMINISTRAR_GAITSCRIPTUSR = "administrarGaitScriptUsr";
	public static final String FWD_GAITSCRIPTUSR_VIEW_ADAPTER = "gaitScriptUsrViewAdapter";
	public static final String FWD_GAITSCRIPTUSR_EDIT_ADAPTER = "gaitScriptUsrEditAdapter";	
	// <--- GaitScriptUsr
	
	// ----> Direccion
	public static final String ACTION_BUSCAR_DIRECCION    	    = "buscarDireccion";
	public static final String ACTION_ADMINISTRAR_DIRECCION  	= "administrarDireccion";
	public static final String ACTION_ADMINISTRAR_ENC_DIRECCION = "administrarEncDireccion";
	public static final String FWD_DIRECCION_SEARCHPAGE 	    = "direccionSearchPage";
	public static final String FWD_DIRECCION_VIEW_ADAPTER 	    = "direccionViewAdapter";
	public static final String FWD_DIRECCION_ADAPTER 	    	= "direccionAdapter";
	public static final String PATH_ADMINISTRAR_DIRECCION 		= "/apm/AdministrarDireccion";	
	public static final String FWD_DIRECCION_ENC_EDIT_ADAPTER 	= "direccionEncEditAdapter";
	// <--- Direccion
	
	
	// ---> Direccion Aplicacion Perfil
	public static final String ACTION_ADMINISTRAR_DIRECCIONAPLICACIONPERFIL = "administrarDireccionAplicacionPerfil";
	public static final String FWD_DIRECCIONAPLICACIONPERFIL_VIEW_ADAPTER = "direccionAplicacionPerfilViewAdapter";
	public static final String FWD_DIRECCIONAPLICACIONPERFIL_EDIT_ADAPTER = "direccionAplicacionPerfilEditAdapter";	
	// <--- Direccion Aplicacion Perfil
	
	// ----> Area Aplicacion Perfil
	public static final String ACTION_ADMINISTRAR_AREAAPLICACIONPERFIL = "administrarAreaAplicacionPerfil";
	public static final String FWD_AREAAPLICACIONPERFIL_VIEW_ADAPTER = "areaAplicacionPerfilViewAdapter";
	public static final String FWD_AREAAPLICACIONPERFIL_EDIT_ADAPTER = "areaAplicacionPerfilEditAdapter";
	public static final String PATH_ADMINISTRAR_AREAAPLICACIONPERFIL = "/def/AdministrarAreaAplicacionPerfil";
	// <--- Area Aplicacion Perfil
}