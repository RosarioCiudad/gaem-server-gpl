			...
			<fieldset>
				...
				<table class="tabladatos">
					...
					<tr>
						...
						<td class="normal" colspan="4"><bean:write name="formularioAdapterVO" property="formulario.observacion" /></td>
					</tr>
				</table>
			</fieldset>	
			<!-- Proceso -->
				...
				<logic:notEmpty  name="formularioAdapterVO" property="formulario.listFormularioDetalle">	    	
					...
					<logic:iterate id="FormularioDetalleVO" name="formularioAdapterVO" property="formulario.listFormularioDetalle">
						<tr>
							...
							<!-- Modificar-->								
							<td>
								<logic:equal name="formularioAdapterVO" property="modificarFormularioDetalleEnabled" value="enabled">
									<logic:equal name="FormularioDetalleVO" property="modificarEnabled" value="enabled">
										<a style="cursor: pointer; cursor: hand;" onclick="submitForm('modificarFormularioDetalle', '<bean:write name="FormularioDetalleVO" property="id" bundle="base" formatKey="general.format.id"/>');">
											<img title="<bean:message bundle="base" key="abm.button.modificar"/>" border="0" src="<%=request.getContextPath()%>/images/iconos/modif0.gif"/>
										</a>
									</logic:equal>	
									<logic:notEqual name="FormularioDetalleVO" property="modificarEnabled" value="enabled">
										<img border="0" src="<%=request.getContextPath()%>/images/iconos/modif1.gif"/>
									</logic:notEqual>
								</logic:equal>
								<logic:notEqual name="formularioAdapterVO" property="modificarFormularioDetalleEnabled" value="enabled">
									<img border="0" src="<%=request.getContextPath()%>/images/iconos/modif1.gif"/>
								</logic:notEqual>
							</td>
							<!-- Eliminar-->								
							<td>
								<logic:equal name="formularioAdapterVO" property="eliminarFormularioDetalleEnabled" value="enabled">
									<logic:equal name="FormularioDetalleVO" property="eliminarEnabled" value="enabled">
										<a style="cursor: pointer; cursor: hand;" onclick="submitForm('eliminarFormularioDetalle', '<bean:write name="FormularioDetalleVO" property="id" bundle="base" formatKey="general.format.id"/>');">
											<img title="<bean:message bundle="base" key="abm.button.eliminar"/>" border="0" src="<%=request.getContextPath()%>/images/iconos/eliminar0.gif"/>
										</a>
									</logic:equal>	
									<logic:notEqual name="FormularioDetalleVO" property="eliminarEnabled" value="enabled">
										<img border="0" src="<%=request.getContextPath()%>/images/iconos/eliminar1.gif"/>
									</logic:notEqual>
								</logic:equal>
								<logic:notEqual name="formularioAdapterVO" property="eliminarFormularioDetalleEnabled" value="enabled">
									<img border="0" src="<%=request.getContextPath()%>/images/iconos/eliminar1.gif"/>
								</logic:notEqual>
							</td>
