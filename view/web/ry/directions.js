 ...
 */
/**
 * Js que sirve para dar la funcionalida de las orientaciones de los segmento del recorrido del tranporte urbano 
 */
...
createLineStringDirection = function(line,position, forEachSegment){
	...
	/**
	 * Modificacion que se agrega para que los sentidos aparezcan separados cada 7 segmentos, solo si el segmento mide mas de 50 metros.
	 */
	for (var i=0;i<segs.length ;i+=7 )	{		
		if ( getSegmentLength(segs[i]) > 50 ) { 
