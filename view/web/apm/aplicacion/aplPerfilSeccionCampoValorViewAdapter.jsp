...
<html:form styleId="filter" action="/apm/AdministrarAplPerfilSeccionCampoValor.do">
		...
		<h1><bean:message bundle="apm" key="apm.aplPerfilSeccionCampoValorViewAdapter.title"/></h1>	
	    	...
	    	<tr>
  	    		<td align="left" width="50%">
	   	    	...
	   	    	<td align="right" width="50%">
					<logic:equal name="aplPerfilSeccionCampoValorAdapterVO" property="act" value="eliminar">
