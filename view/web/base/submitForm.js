...
function DisableLinks(){
	...
	for (i = 0; i < objLinks.length; i++) {
		...
		//si empieza con gaitmenu, no lo deshabilitamos.
		if (id != null && id.substring(0,8) == "gaitmenu") {
		  break;
		}
...
/* funcion llamada en cada unload de pagina del gait*/
function unload() {
...
/* si url no empieza con /gait/, le aniade /gait a la url*/
function gaitRequest(url) {
    var req = httpRequest();
	var prefix = '/gait/';
