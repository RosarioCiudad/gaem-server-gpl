					...
					<tr>
						<td colspan="2" align="center">
							<table border="0">
								<tr>
									<td align="right">
										<a href="<%=request.getContextPath()%>/base/gaitException.jsp" target="_blank">
											<img border="0" src="<%=request.getContextPath()%>/images/message0.png"/>
										</a>										
									</td>
									<td align="left">
										Ha ocurrido un error durante la navegaci&oacute;n. 
										<br/>Recuerde que no debe utilizar los botones 'Atr&aacute;s y Adelante' del Navegador, utilice los botones Volver de cada p&aacute;gina del Gait.
