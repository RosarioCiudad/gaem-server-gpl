...
<html:form styleId="filter" action="/pro/BuscarCorrida.do">
	...
	<legend><bean:message bundle="base" key="base.parametrosBusqueda"/></legend>
		<table class="tabladatos">
			<!-- Proceso -->
			<logic:empty name="corridaSearchPageVO" property="corrida.proceso.codProceso">
			<tr>
			...
			<tr>
				...
				<td class="normal">
					...
					<a class="link_gait" onclick="return show_calendar('fechaDesdeView');" id="a_fechaDesdeView">
			...
			<!-- fecha Hasta -->	
				...
				<td class="normal">
					...
					<a class="link_gait" onclick="return show_calendar('fechaHastaView');" id="a_fechaHastaView">
						<img border="0" src="<%= request.getContextPath()%>/images/calendario.gif"/></a>
				</td>				
			</tr>
		</table>
