...
<html:form styleId="filter" action="/pro/AdministrarProceso.do">
	...
	<fieldset>
		...
		<tr>
			<td><label>&nbsp;<bean:message bundle="pro" key="pro.proceso.cantCorridasPerm.label"/>: </label></td>
			<td class="normal"><html:text name="procesoAdapterVO" property="proceso.cantCorridasPerm" size="2" maxlength="2"/></td>		
		</tr>
